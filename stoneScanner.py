...
#dpSubprocess.load_background_image(image='background.png')
...
def playVideo(video, pre_path='/home/pi/stoneScanner/data/videos/'):
    video_path = pre_path + video
    cmd = 'sudo '+'omxplayer ' + video_path
...
def main():
	q = mp.Queue()
	p1 = mp.Process(target=motionDT, args=(q,))
	p1.start()
	pid = p1.pid
	sleep(5.0)
    #lablePrint()
	#playVideo(video='stone.mp4')
	while(1):
		res1 = q.get()
		print(res1)
		if res1 == 1:
